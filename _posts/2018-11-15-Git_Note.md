...
# 核心概念
## 2.1 仓库/分支/区
![git管理文件与/暂存区](../img/181115_git_note/concept01.png)  
git管理文件与/暂存区  

 

![工作区与暂存区概念](../img/181115_git_note/concept02.png)  
工作区与暂存区概念  



![库、分支、工作区的关系](../img/181115_git_note/concept03.png)  
库、分支、工作区的关系  
...
## 2.2 文件的生命周期
![git管理文件时文件的生命周期](../img/181115_git_note/file_lifecycle_by_git.png)  
...
--- 
![简短输出样式图](../img/181115_git_note/status-s.png)  
?? 表示文件未被Git追踪  
A  表示新增文件  
...
![--no-ff区别](../img/181115_git_note/diff_no_ff.png)
